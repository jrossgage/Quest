...
namespace Quest
{
    ...
    public class Challenge
    {
        ...
        public void RunChallenge(Adventurer adventurer)
        {
            ...
            int numAnswer;
            //int.TryParse will try to parse out the string "answer" into an integer. If successful (meaning that the user typed out numbers rather
            //than other characters) it will return true and be stored in "isNumber". The parsed integer will then be stored in the designated variable
            // in this case, numAnswer)
